...
object SecurityUtils {
    ...
    fun isAppSignatureValid(context: Context): Boolean {
        ...
        // For now, we return true so it doesn't break development,
        // but we log the signature so the user can see it.
        val EXPECTED_SIGNATURE = "DEBUG_SIGNATURE_PLACEHOLDER"
        return currentSignature != null // Add check: currentSignature == EXPECTED_SIGNATURE in prod
    }
