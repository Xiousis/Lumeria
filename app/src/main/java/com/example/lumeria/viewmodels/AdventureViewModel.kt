...
import com.example.lumeria.database.WorldEventDatabase
import com.example.lumeria.models.EventOutcome
import com.example.lumeria.models.WorldEvent
    ...
    fun processEventOutcome(
        ...
        when (outcome) {
            is EventOutcome.Reward -> {
                ...
                if (outcome.xp > 0) {
                     val stats = XiousStats(playerData.level, playerData.xp).gainXp(outcome.xp)
            ...
            is EventOutcome.Buff -> {
                ...
                if (outcome.buff.type == com.example.lumeria.models.BuffType.HealthRegen) {
