...
data class BattleUiState(
    ...
    val enemyDamageDebuffTurns: Int = 0,
    val enemyEvasionBuffTurns: Int = 0,
    ...
    val defenseBuffTurns: Int = 0,
    val evasionBuffTurns: Int = 0,
    ...
    val arenaMoveset: List<com.solerforge.lumeria.database.BossAttack> = emptyList(),
