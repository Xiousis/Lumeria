...
object StoryDatabase {
    ...
    val arcs = listOf(
        ...
        StoryArc(
            id = 21,
            title = "The Echo of the Legend",
            requiredLevel = 80,
            description = "Face the spirit of the one who came before.",
            backgroundId = R.drawable.royal_court_bg,
            locationName = "The Eternal Realm",
            events = listOf(
                StoryEvent.Dialogue("Spirit", "You walk the path of the founder, but is your spirit as strong?"),
                StoryEvent.Dialogue("Spirit", "To lead Lumeria into the new era, you must surpass the legend."),
                StoryEvent.Battle("The Echo of Xious", isBoss = true),
                StoryEvent.Dialogue("Spirit", "Well done, successor. The future is yours.")
            ),
            rewardXp = 2000000,
            rewardGold = 0,
            rewardTitle = "True Successor"
        )
    ).sortedBy { it.id }
